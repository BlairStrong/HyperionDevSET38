...
#creating multiple nlp models for comparison
...
#creating different models with the same sample
model_sentence_sm = nlp_sm(comparison_sentence)
model_sentence_md = nlp_md(comparison_sentence)

#looping through the sample against each comparator and printing for each model
